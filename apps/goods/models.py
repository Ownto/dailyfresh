...
__all__ = ['GoodsType', 'GoodsSKU', 'Goods', 'GoodsImage', 'IndexGoodsBanner',
...
class GoodsSKU(BaseModel):
    ...
    type = models.ForeignKey('GoodsType', verbose_name='商品种类', null=True, on_delete=models.SET_NULL)
    goods = models.ForeignKey('Goods', verbose_name='商品SPU', null=True, on_delete=models.SET_NULL)
